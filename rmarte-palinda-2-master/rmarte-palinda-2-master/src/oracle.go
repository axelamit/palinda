...
func Oracle() chan<- string {
	...
	go random_nonsense(answers)
	go print_answers(answers)
...
func random_nonsense(answers chan<- string) {
	nonsense := [2]string{
	...
	for {
		...
		answers <- nonsense[rand.Intn(2)]
	}
}

func print_answers(answers <-chan string) {
